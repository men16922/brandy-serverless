...
def get_s3_manager() -> S3Manager:
    """Get S3Manager instance (AWS-only)"""
    bucket_name = os.getenv('S3_BUCKET', 'ai-branding-chatbot-assets-908601828278')
...
# AWS-only: Buckets are managed via CloudFormation/SAM